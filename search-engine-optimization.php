...
<head>
    <meta charset="utf-8">
    <meta name="keywords" content="Search Engine Optimization, seo, search, google" />
    <meta name="description" content="Search Engine Optimization - Webdeves Technologies" />
    <meta name="author" content="webdeves.com" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Search Engine Optimization - Webdeves Technologies</title>
  ...
  <body>
    ...
    <!--=================================
    Header Inner -->
    <section class="header-inner header-inner-menu bg-overlay-black-30" style="background-image: url('images/header-inner/');">
      <div class="container">
        <div class="row d-flex justify-content-center">
          <div class="col-md-8">
            <div class="header-inner-title text-center">
              <h1 class="font-weight-normal" style="color: #ff8c00">Search Engine Optimization</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 d-flex justify-content-center">
              <ul class="nav">
                <li class="nav-item"><a class="nav-link" href="website-development">Web Design</a></li>
                ...
                <li class="nav-item"><a class="nav-link active" href="search-engine-optimization">Search Engine Optimization</a></li>
                <li class="nav-item"><a class="nav-link" href="start-up">Tech Ideas</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8">
            <div class="section-title text-center">
              <h4 style="color: #ff8c00">TAKE YOUR BUSINESS TO THE NEXT LEVEL</h4>
              <p>Webdeves can increase the search engine rank and site traffic of any company. The expertise offered by its technical and copywriting staff enables Webdeves to successfully meet the needs of companies with complex websites in competitive industries.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6">
            <div class="section-title">
              <h4 class="mb-3" style="color: #ff8c00">Analyze a web site</h4>
                <p class="font-weight-normal text-muted mt-4">We first analyze a web site, followed by a step-by-step plan to have the website communicate keywords more effectively to search engines. Our ultimate goal is to get our clients more visitors and higher conversion of sales and leads</p>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="row">
              <div class="col-sm-6">
                  <img src="images/branding%20webdeves.jpg" alt="branding image" width="500px">
      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-sm-6">
                  <img src="images/tab-h2-seo2.jpg" alt="branding image" width="400px" height="300px">
...
On-Page &amp; Off-Page Optimization</h4>
                <p class="font-weight-normal text-muted mt-4">The goal of on page and off page optimization is to generate a theme consistent with your targeted keywords. The search engine is a robot, not a human … and therefore, you must follow our proven process to educate the robot so that it brings your website up when your potential customers are searching for specific business related keywords.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="space-ptb bg-light">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-9">
            <div class="section-title text-center">
              <h2 style="color: #ff8c00">HOW WE DO</h2>
              <p>Before beginning a search engine optimization (SEO) project, it is important to understand the process involved in an effective SEO campaign. Webdeves caters to clients who require an intensive, full-service approach to search engine marketing.</p>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
            <div class="category-box category-box-style-01">
              <div class="category-icon">
                <h5 class="category-title mb-0" style="color: #mff8c00">KEYWORD RESEARCH</h5>
              </div>
              <p class="font-weight-normal text-muted mt-4">Keyword density tells you how often a search term appears in a text in relation to the total number of words it contains</p>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
            <div class="category-box category-box-style-01">
              <div class="category-icon">
                <h5 class="category-title mb-0" style="color: #ff8c00">ONSITE OPTIMIZATION</h5>
              </div>
              <p class="font-weight-normal text-muted mt-4">Onpage optimization refers to all measures that can be taken directly within the website in order to improve its position</p>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6 mb-4 mb-sm-0">
            <div class="category-box category-box-style-01">
              <div class="category-icon">
                <h5 class="category-title mb-0" style="color: #ff8c00">LINK<br> BUILDING</h5>
              </div>
              <p class="font-weight-normal text-muted mt-4">In the field of SEO, link building describes actions aimed at increasing the number and quality of inbound links to a webpage</p>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6">
            <div class="category-box category-box-style-01">
              <div class="category-icon">
                <h5 class="category-title mb-0" style="color: #ff8c00">REPORTING AND ANALYSIS</h5>
              </div>
                 <p class="font-weight-normal text-muted mt-4">Our SEO review consists of several factors like a content, linking structure, social media efforts, and its trust on the internet</p>
            </div>
          </div>
        </div>
      </div>
