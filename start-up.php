...
<head>
    <meta charset="utf-8">
    <meta name="keywords" content="Start-up Ideas - Webdeves Technologies" />
    <meta name="description" content="Start-up Ideas - Webdeves Technologies - Webdeves Technologies" />
    <meta name="author" content="webdeves.com" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Start-up Ideas - Webdeves Technologies</title>
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-md-12">
            <div class="header-inner-title text-center">
              <h1 class="text-white font-weight-normal mb-0">Start-up Ideas</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8">
            <div class="section-title text-center">
              <h4 style="color: #ff8c00">Start Work Now</h4>
               <p class="font-weight-normal text-muted mt-4">Starting up a new business can be incredibly difficult. After all, it takes a lot more than a great idea and a pocket full of dreams in order to disrupt markets and generate success.</p>
                 <p class="font-weight-normal text-muted mt-4">At Webdeves we believe that having a businees plan is very important and neccesary for every start-up. And will be required when seeking for an Angel investor or Venture capitalist.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
          ...
          <div class="col-lg-6">
            <div class="section-title">
             <img src="images/webdeves-office/reduced%202.jpg" width="400px" alt="Webdeves Team">
            </div>
          </div>
     
              <div class="col-sm-6">
                <p class="font-weight-normal text-muted mt-4 text-dark">At Webdeves we love to help startup and entrepreneur achieve their business goals and get their business ideas to work. We make sure we provide every necessary solutions that will transform your business. As an entrepreneur or startup you have made the first move of transforming / improving your business by visiting our website.</p>
            </div>
        </div></center>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="dark-background bg-dark border-radius p-4 p-sm-5 bg-overlay-black-90">
              <div class="row">
                <div class="col-lg-7 mb-4 mb-lg-0 align-self-center" style="align-content: center">
                  <div class="section-title">
                    <h2 class="text-white">Let’s Make That Idea A Reality</h2>
                    <p class="lead text-white">What are the challenges you are facing now as an entrepreneur / startup?</p><br>
                      <ul class="list list-unstyled">
                      <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span  style="color: #fff">Lack of sales</span></li>
                      <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span  style="color: #fff">Business funding </span></li>
                      <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span  style="color: #fff">Don’t know where to start on setting up your business idea</span></li>
                      <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span  style="color: #fff">Business research and market analysis</span></li>
                      <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span style="color: #fff">Lack of strategies </span></li>
                      <li class="d-flex"><i class="fas fa-check pr-2 pt-1 text-primary"></i><span  style="color: #fff">Management, name it. All you have to do is to contact us through our contact channels or book an appointment with one of our professionals, we will make sure we deploy every necessary resources to transform your Idea because our language is transformation and improvement.</span></li>
                    </ul>
                  </div>
              <div class="contact-form contact-form-style-02">
                    <form id="contact-form" method="post" action="contactform.php">
                      <div class="form-row">
                        ...
                        <div class="col-md-6 mb-4">
                          <label class="inp">
                            <input name="mail" class="form-control" type="email" placeholder="&nbsp;">
                        ...
                        <div class="col-12 mb-4">
                          <label class="inp">
                            <input name="subject" class="form-control" type="text" placeholder="&nbsp;">
                        ...
                        <div class="col-12 mb-4">
                          <label class="inp">
                            <textarea name="message" class="form-control" placeholder="&nbsp;" rows="3"></textarea>
                ...
                <div class="col-lg-5 text-center px-xl-5">
                  <div class="bg-dark border-radius p-4 d-flex h-100">
